...
## WeChat Mini Program Modifications

This fork has been adapted for WeChat Mini Program environments:

* Replaced `wasm32`-specific `Math.random` in Rust-generated WASM with JS `Math.random()` for random number generation
