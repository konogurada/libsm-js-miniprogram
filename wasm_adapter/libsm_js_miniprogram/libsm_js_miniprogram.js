/**
 * Custom TextDecoder/TextEncoder based glue layer for WeChat Mini Programs
 *
 * <p>Uses a custom TextDecoder/TextEncoder because the global objects are not available in Mini Programs</p>
 * <p>Removed remote WASM fetching as it is not allowed in WeChat Mini Programs</p>
 */
import {TextDecoder, TextEncoder} from "./text_encoder";
...
async function __wbg_load(module, imports) {
    return await WXWebAssembly.instantiate(module, imports);
}
